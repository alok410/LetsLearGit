...
export const EmpPendingReq = () => {
 ...
 useEffect(() => {
  ...
  const pendingReq = filteredData.filter(request => request.LeaveStatus == 'Pending');
...
const handleDenyFinal = (selectedId) => {
  ...
  return (
    <>
    <div className='heading-font'>Employee Pending Request</div>
  ...
  <div className="modal-content">
    ...
    <textarea value={reason} onChange={(e) => setReason(e.tafrget.value)} />
